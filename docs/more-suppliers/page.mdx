...
<Alert type="warning" description="Before adding the Supplier please contact Supplier's team to get your credentials. 
...
<ColumnGroup>
    ...
    <ColumnItem center={true}>
        <Alert type="error" description="Important Notice">
