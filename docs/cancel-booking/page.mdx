...
<Alert type="warning" description="Cancellation rules are defined by Supplier and could be different from tour to tour. As an Agent you need to have full information about cancellation policy for every Tour/Excursion">
Important!
</Alert>
...
<Alert type="warning" description=" If you choose Cancel — reservation will be marked as cancelled (no show) for all tourists within this booking. If you want to cancel the reservation Partially (for example only 1 out of 3 tourists want to cancel) you should choose Edit action (see how to Edit the reservation)">
Important!
</Alert>
